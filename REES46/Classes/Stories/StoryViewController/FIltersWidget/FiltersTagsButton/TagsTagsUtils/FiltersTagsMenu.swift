...
class FiltersTagsMenu {
    ...
    static func fetch()->[FiltersTagsMenu] {
        let fetchList = [FiltersTagsMenu(filterId: -1, title: "T", titleFiltersValues: ["String"], selected: true),
                        FiltersTagsMenu(filterId: -2, title: "S", titleFiltersValues: ["String"], selected: true),
        ]
        return fetchList
    }
}

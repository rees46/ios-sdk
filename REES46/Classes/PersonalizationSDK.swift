...
public extension PersonalizationSDK {
    ...
    func recommend(timeOut: Double? = nil, blockId: String, currentProductId: String? = nil, completion: @escaping (Result<RecommenderResponse, SDKError>) -> Void) {
        recommend(timeOut: timeOut, blockId: blockId, currentProductId: currentProductId, completion: completion)
    }
    ...
    func search(timeOut: Double? = nil, query: String, limit: Int? = nil, offset: Int? = nil, categoryLimit: Int? = nil, categories: String? = nil, extended: String? = nil, sortBy: String? = nil, sortDir: String? = nil, locations: String? = nil, brands: String? = nil, filters: [String: Any]? = nil, priceMin: Double? = nil, priceMax: Double? = nil, colors: String? = nil, exclude: String? = nil, email: String? = nil, completion: @escaping(Result<SearchResponse, SDKError>) -> Void) {
        search(timeOut: timeOut, query: query, limit: limit, offset: offset, categoryLimit: categoryLimit, categories: categories, extended: extended, sortBy: sortBy, sortDir: sortDir, locations: locations, brands: brands, filters: filters, priceMin: priceMin, priceMax: priceMax, colors: colors, exclude: exclude, email: email, completion: completion)
    }

...
////        }
//        
//        //NotificationCenter.default.addObserver(self, selector: #selector(FiltersInternalCheckboxCall), name: .init(rawValue: "FiltersInternalCheckboxCall"), object: nil)
//        
...
//        globalSDK?.search(query: "shoes", sortBy: "popular", locations: "10", filters: ["Screen size, inch": ["15.6"]], colors: ["white", "black"], fashionSizes: ["36", "37", "38", "39", "40"], timeOut: 0.2) { queryWithFiltersResponse in
//            print("   Filters search callback")
//            switch queryWithFiltersResponse {
//            case .success(_): break
//                //print("     queryWithFilters search is success")
...
//    }
//    
////    @objc private func FiltersInternalCheckboxCall() {

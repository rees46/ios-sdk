...
public class SearchViewController: SearchWidgetViewController, SearchWidgetDelegate {
    ...
    //private(set)
    public var findedProducts = [SearchWidgetProductPrepare]()
...
//        let fullSearchViewController = storyboard.instantiateViewController(withIdentifier: "detailVC") as! ShopProductDetailsViewController
...
//            }
//            
//            let sProductCollection = SearchWidgetProductPrepare(productId: "", brandTitle: productName, title: productName, price: productPrice, priceNum: Double(numericPrice), oldPrice: "", description: "", mainImage: productImage, imagesArray: [productImagesArray])
        ...
        sdk?.search(query: productText, sortBy: "popular", filtersSearchBy: "name", timeOut: 0.3) { searchResponse in
            ...
            case let .success(searchResponse):
                ...
                for item in searchResponse.products {
                    ...
                    let productSearchedByUser = SearchWidgetProductPrepare(productId: productId,
...
//        let storyboard = UIStoryboard(name: "Main", bundle: nil)
//        let fullSearchViewController = storyboard.instantiateViewController(withIdentifier: "filtersVC") as! FiltersMainViewController
//        fullSearchViewController.modalPresentationStyle = .fullScreen

...
class MainViewController: UIViewController, UIScrollViewDelegate, NetworkStatusObserver {
    ...
    public var searchWidgetController = SearchWidgetView()
        ...
        globalSDK?.searchBlank { searchResponse in
            ...
            case let .success(searchResponse):
                ...
                DispatchQueue.main.async {
                    ...
                    var frameworkBundle = Bundle(for: SearchWidgetView.self)
#if SWIFT_PACKAGE
    ...
    @objc private func didTapReset() {
        ...
        let sdkBundleId = Bundle(for: StoriesView.self).bundleIdentifier
        let appBundleId = Bundle(for: StoriesView.self).bundleIdentifier
